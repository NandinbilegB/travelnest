          ...
          <Card className="w-[1133px] rounded-[20px] shadow-none border-none">
            <CardContent className="p-16">
              <Tabs defaultValue="traveler" className="w-full">
                <TabsList className="w-[596px] h-[83px] mx-auto bg-[#163966] rounded-[20px]">
                  <TabsTrigger
                    value="company"
                    className="w-1/2 h-full [font-family:'Albert_Sans',Helvetica] text-white text-3xl data-[state=active]:bg-transparent data-[state=active]:text-white"
                  >
                    Компани
                  </TabsTrigger>
                  <TabsTrigger
